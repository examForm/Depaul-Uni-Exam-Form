  ...
  return (
    ...
    <div className='mt-5'>
      <Row className='mt-3'>
        <Col md={8} lg={6} className="p-4 border rounded shadow-sm bg-light">
          <div className="border border-2 p-2">
            <p2 className="p-0">You must complete your details before making a payment, according to the school's policy.</p2>
          </div>
          <h2 className="text-center my-4">Registration</h2>
          <p className="text-center mb-4">
            Enter only correct details to avoid <span style={{ color: "#FF0000" }}>error(s)</span>
          </p>
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group controlId="formToWhom" className="mt-4">
              <Form.Label>Who are you paying for?</Form.Label>
              <Form.Control
                type="text"
            ...
            <Form.Group controlId="formRelation" className="mt-4">
              <Form.Label>Who is this person to you?</Form.Label>
              <Form.Check
                type="radio"
                label="Wife"
                name="relation"
      ...
      <Modal show={showConfirmModal} onHide={() => setShowConfirmModal(false)}>
        ...
        <Modal.Body>
          <p>
            Please confirm and verify your details before submitting to avoid{" "}
            <span style={{ color: "#FF0000" }}>error(s)</span>
          </p>
          <Button variant="primary" onClick={handleConfirm}>
          <a href='https://examform.github.io/Depaul-Uni-Exam-Form-Pay/' target='blank' className='text-light text-decoration-none'>Yes, I Have Confirmed</a>
          </Button>
        </Modal.Body>
      </Modal>
